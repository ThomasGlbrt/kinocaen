 ...
 */
final class Version20230213131104 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE type_competences (id INT AUTO_INCREMENT NOT NULL, intitule VARCHAR(200) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE inscrit_session ADD Porteur_Projet VARCHAR(3) NULL');
        $this->addSql('ALTER TABLE session DROP porter_projet');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE type_competences');
        $this->addSql('ALTER TABLE session ADD porter_projet INT DEFAULT NULL');
    }
}
